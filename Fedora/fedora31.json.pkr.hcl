...
variable "iso_checksum" {
  type    = string
  default = "5be8debd3e8fb4e86b9fbf67c7eb66ea598d2b7ad0c7ba8d505ce88067b43444"
}

variable "iso_url" {
  type    = string
  default = "http://mirror.nodesdirect.com/fedora/releases/31/Server/x86_64/iso/Fedora-Server-netinst-x86_64-31-1.9.iso"
}
...
variable "vagrant_box_tag" {
  type    = string
  default = "${env("VAGRANT_CLOUD_USER")}/fedora31"
}
