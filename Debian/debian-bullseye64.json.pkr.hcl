...
build {
  sources = ["source.proxmox-iso.debian", "source.qemu.debian", "source.vagrant.debian", "source.virtualbox-iso.debian", "source.virtualbox-ovf.debian", "source.vmware-iso.debian", "source.vmware-vmx.debian", "source.vsphere-iso.debian"]
