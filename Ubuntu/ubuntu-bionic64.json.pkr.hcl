...
variable "iso_url" {
  type    = string
  default = "http://cdimage.ubuntu.com/releases/18.04.5/release/ubuntu-18.04.6-server-amd64.iso"
}
...
variable "vagrant_box_tag" {
  type    = string
  default = "${env("VAGRANT_CLOUD_USER")}/bionic64"
}
...
source "proxmox-iso" "ubuntu" {
  boot_command            = ["<enter><wait><f6><esc><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs><bs>", "<wait>", "/install/vmlinuz", "<wait>", " initrd=/install/initrd.gz", "<wait>", " auto=true", "<wait>", " priority=critical", "<wait>", " url=http://{{ .HTTPIP }}:{{ .HTTPPort }}/ubuntu/preseed.cfg <wait>", "<wait>", "<enter>"]
